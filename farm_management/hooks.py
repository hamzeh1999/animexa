...
fixtures = [
    ...
    },
    {
        ...
        "filters": [
            [
                ...
                [
                    "Incident Log Report",
                    "Pending Incident Log Report",
                    "Vaccination Record Report",
    ...
    },
    {
        "dt": "Dashboard Chart",
        "filters": [
            ["name", "in", ["House Occupancy Status", "Farm Operational Status"]]
        ],
    },
    {
        "dt": "Dashboard",
...
# 	"Task": "farm_management.custom.task.CustomTaskMixin"
# }
